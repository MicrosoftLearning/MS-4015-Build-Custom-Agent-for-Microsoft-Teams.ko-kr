...
**참고:** 자체 환경을 사용하는 학습자의 경우, 학습자는 **구독** , **가격 책정 계층** 및 **리소스 그룹** 필드 값을 선택할 때 재량권을 사용해야 합니다. Skillable 랩 환경을 사용하는 학습자의 경우, 아래 단계의 필드에 대한 기본값을 선택합니다.
...
**참고:** 자신의 환경을 사용하는 학습자의 경우, 사용자는 아래 단계의 필드를 채울 때 자신의 재량권을 사용해야 할 수 있습니다. Skillable 환경을 사용하는 학습자의 경우, 아래 a-b 단계에 설명된 대로 기본값을 사용합니다. 
...
3. 화면 맨 위에 있는 빈 상자에 먼저 다음을 입력합니다.
   ...
   **참고:** g-i 단계는 Microsoft Teams 관리 센터에 대한 관리자 액세스 권한이 없는 사용자 환경 및/또는 Skillable 환경을 사용하는 학습자의 경우 완료해야 합니다.
